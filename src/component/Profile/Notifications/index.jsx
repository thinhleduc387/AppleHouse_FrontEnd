...
const formatNotificationDate = (dateString, language, t) => {
  try {
...
const NotificationStorage = () => {
  ...
  const markAllAsRead = async () => {
    try {
      ...
      toast.error(t("errorMarkAllAsRead"));
    }
  };
  ...
  return (
    <div className="bg-[#f3f4f6] dark:bg-gray-900 transition-colors duration-300 max-w-6xl mx-auto p-6">
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md dark:shadow-gray-700 p-8 mb-6 font-sans">
        {/* Header */}
        <div className="mb-8 flex justify-between items-center">
          ...
          {notifications.some((notif) => !notif.isRead) && (
            <button
              className="text-blue-600 dark:text-blue-400 text-base font-semibold hover:underline hover:text-blue-800 dark:hover:text-blue-300 transition-colors duration-300"
        ...
        {/* Tabs */}
        <div className="flex space-x-6 mb-8 border-b border-gray-200 dark:border-gray-600">
          <button
          ...
          {isLoading ? (
            <div className="flex justify-center items-center py-12">
              <div className="relative">
                ...
                <div className="absolute top-0 left-0 w-12 h-12 border-4 border-gray-200 dark:border-gray-600 rounded-full"></div>
              </div>
            ...
            notifications.map((notification) => (
              <div
                ...
                className={`relative p-6 rounded-xl transition-all duration-300 border cursor-pointer ${
                  !notification.isRead
                    ? "bg-blue-50 dark:bg-blue-900/30 border-blue-200 dark:border-blue-600 hover:bg-blue-100 dark:hover:bg-blue-900/50 hover:shadow-lg dark:hover:shadow-gray-700"
                    : "bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-700 hover:shadow-md dark:hover:shadow-gray-700"
                }`}
              >
                <div className="flex items-start gap-4">
                  <div className="relative flex-shrink-0">
                    ...
                    />
                    {!notification.isRead && (
                      <span className="absolute -top-1 -right-1 w-3.5 h-3.5 bg-blue-600 dark:bg-blue-400 rounded-full border-2 border-white dark:border-gray-800"></span>
                    )}
                  </div>
                  <div className="flex-1 min-w-0">
                    ...
                    {notification.actionUrl && (
                      <a
                        ...
                        className="inline-flex items-center mt-2 text-sm text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 font-semibold transition-colors duration-300"
...
export default memo(NotificationStorage);
